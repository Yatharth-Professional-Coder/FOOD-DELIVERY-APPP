        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center mb-12">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    ...
                    <span className="block text-brand-600 xl:inline">right place.</span>
                </h1>
                        ...
                        <Link to={`/restaurant/${restaurant._id}`} key={restaurant._id} className="group block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                            <div className="relative h-48 w-full bg-gray-100">
                                {restaurant.image ? (
                                    ...
                                    <div className="w-full h-full flex items-center justify-center text-brand-600 text-4xl font-bold bg-brand-50">
                            ...
                            <div className="p-5">
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className="bg-accent-100 text-accent-800 text-xs px-2 py-1 rounded font-bold flex items-center gap-1">
                                        ★ 4.5
                                    </span>
                                </div>
